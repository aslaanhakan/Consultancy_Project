        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConsultantId = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisitsPrice = table.Column<decimal>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CertificateTime = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "TEXT", nullable: true),
                    DegreeofGraduation = table.Column<string>(type: "TEXT", nullable: true),
                    StartDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    GraduationTime = table.Column<DateTime>(type: "TEXT", nullable: false),
                    ConsultantId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConsultantId1 = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomersConsultans", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomersConsultans_Consultants_ConsultantId1",
                        column: x => x.ConsultantId1,
                        principalTable: "Consultants",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CustomersConsultans_Customers_CustomerId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomersConsultans_ConsultantId1",
                table: "CustomersConsultans",
                column: "ConsultantId1");

            migrationBuilder.CreateIndex(
                name: "IX_CustomersConsultans_CustomerId1",
                table: "CustomersConsultans",
                column: "CustomerId1");
