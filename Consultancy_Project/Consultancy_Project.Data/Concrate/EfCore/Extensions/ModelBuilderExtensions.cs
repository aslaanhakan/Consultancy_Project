...
namespace Consultancy_Project.Data.Concrate.EfCore.Extensions
{
    public static class ModelBuilderExtensions
    {
        public static void SeedData(this ModelBuilder modelBuilder)
        {
            ...
            {
                new Consultant {Id=1,UserId=users[1].Id, Promotion="<p>Elif Tuncel, lisans eğitimini Boğazi&ccedil;i &Uuml;niversitesi Psikoloji b&ouml;l&uuml;m&uuml;nde tamamlamıştır. Aynı &uuml;niversitede Klinik Psikoloji Y&uuml;ksek Lisans programını tamamlayarak Uzman Klinik Psikolog unvanını almıştır. Doktora programına devam etmektedir.</p>",  VisitsPrice = 250, JobTitle="Psikolojik Danışman", Confirmation=true },
                new Consultant {Id=2,UserId=users[2].Id, Promotion="<p>Elif Tuncel, lisans eğitimini Boğazi&ccedil;i &Uuml;niversitesi Psikoloji b&ouml;l&uuml;m&uuml;nde tamamlamıştır. Aynı &uuml;niversitede Klinik Psikoloji Y&uuml;ksek Lisans programını tamamlayarak Uzman Klinik Psikolog unvanını almıştır. Doktora programına devam etmektedir.</p>", VisitsPrice = 100, JobTitle="Klinik Psikolog", Confirmation=true},
                new Consultant {Id=3,UserId=users[3].Id, Promotion="<p>Elif Tuncel, lisans eğitimini Boğazi&ccedil;i &Uuml;niversitesi Psikoloji b&ouml;l&uuml;m&uuml;nde tamamlamıştır. Aynı &uuml;niversitede Klinik Psikoloji Y&uuml;ksek Lisans programını tamamlayarak Uzman Klinik Psikolog unvanını almıştır. Doktora programına devam etmektedir.</p>", VisitsPrice = 100 ,  JobTitle="Psikolog", Confirmation = true},
                new Consultant {Id=4,UserId=users[4].Id, Promotion="<p>Elif Tuncel, lisans eğitimini Boğazi&ccedil;i &Uuml;niversitesi Psikoloji b&ouml;l&uuml;m&uuml;nde tamamlamıştır. Aynı &uuml;niversitede Klinik Psikoloji Y&uuml;ksek Lisans programını tamamlayarak Uzman Klinik Psikolog unvanını almıştır. Doktora programına devam etmektedir.</p>", VisitsPrice = 100, JobTitle="Psikolojik Danışman", Confirmation = true},
                new Consultant {Id=5,UserId=users[5].Id, Promotion="<p>Elif Tuncel, lisans eğitimini Boğazi&ccedil;i &Uuml;niversitesi Psikoloji b&ouml;l&uuml;m&uuml;nde tamamlamıştır. Aynı &uuml;niversitede Klinik Psikoloji Y&uuml;ksek Lisans programını tamamlayarak Uzman Klinik Psikolog unvanını almıştır. Doktora programına devam etmektedir.</p>", VisitsPrice = 100 , JobTitle="Psikolojik Danışman", Confirmation = true},
                new Consultant {Id=6,UserId=users[6].Id, Promotion="<p>Elif Tuncel, lisans eğitimini Boğazi&ccedil;i &Uuml;niversitesi Psikoloji b&ouml;l&uuml;m&uuml;nde tamamlamıştır. Aynı &uuml;niversitede Klinik Psikoloji Y&uuml;ksek Lisans programını tamamlayarak Uzman Klinik Psikolog unvanını almıştır. Doktora programına devam etmektedir.</p>", VisitsPrice = 100 , JobTitle="Psikolojik Danışman", Confirmation = true},
                new Consultant {Id=7,UserId=users[7].Id, Promotion="<p>Elif Tuncel, lisans eğitimini Boğazi&ccedil;i &Uuml;niversitesi Psikoloji b&ouml;l&uuml;m&uuml;nde tamamlamıştır. Aynı &uuml;niversitede Klinik Psikoloji Y&uuml;ksek Lisans programını tamamlayarak Uzman Klinik Psikolog unvanını almıştır. Doktora programına devam etmektedir.</p>", VisitsPrice = 100, JobTitle="Psikolojik Danışman", Confirmation = true}
            };
